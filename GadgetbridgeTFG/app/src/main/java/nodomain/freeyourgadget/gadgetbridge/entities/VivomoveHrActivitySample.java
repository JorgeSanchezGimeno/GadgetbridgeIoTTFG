 ...
 */
public class VivomoveHrActivitySample extends AbstractActivitySample  implements java.io.Serializable {
    ...
    private transient VivomoveHrActivitySampleDao myDao;
    ...
    public VivomoveHrActivitySample() {
    }

    public VivomoveHrActivitySample(int timestamp, long deviceId) {
        this.timestamp = timestamp;
        this.deviceId = deviceId;
    }

    public VivomoveHrActivitySample(int timestamp, long deviceId, long userId, int steps, int rawKind, int rawIntensity, int heartRate, Integer caloriesBurnt, Integer floorsClimbed) {
        this.timestamp = timestamp;
        this.deviceId = deviceId;
        this.userId = userId;
        this.steps = steps;
    ...
    public void __setDaoSession(DaoSession daoSession) {
        ...
        myDao = daoSession != null ? daoSession.getVivomoveHrActivitySampleDao() : null;
    }
