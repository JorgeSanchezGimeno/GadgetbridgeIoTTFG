 ...
 */
public class XiaomiActivitySample extends AbstractActivitySample  implements java.io.Serializable {
    ...
    private transient XiaomiActivitySampleDao myDao;
    ...
    public XiaomiActivitySample() {
    }

    public XiaomiActivitySample(int timestamp, long deviceId) {
        this.timestamp = timestamp;
        this.deviceId = deviceId;
    }

    public XiaomiActivitySample(int timestamp, long deviceId, long userId, int rawIntensity, int steps, int rawKind, int heartRate, Integer stress, Integer spo2) {
        this.timestamp = timestamp;
        this.deviceId = deviceId;
        this.userId = userId;
    ...
    public void __setDaoSession(DaoSession daoSession) {
        ...
        myDao = daoSession != null ? daoSession.getXiaomiActivitySampleDao() : null;
    }
