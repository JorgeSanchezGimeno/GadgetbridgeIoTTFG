 ...
 */
public class Wena3EnergySample extends AbstractTimeSample  {
    ...
    private transient Wena3EnergySampleDao myDao;
    ...
    public Wena3EnergySample() {
    }

    public Wena3EnergySample(long timestamp, long deviceId) {
        this.timestamp = timestamp;
        this.deviceId = deviceId;
    }

    public Wena3EnergySample(long timestamp, long deviceId, long userId, int energy) {
        this.timestamp = timestamp;
        this.deviceId = deviceId;
        this.userId = userId;
        this.energy = energy;
    ...
    public void __setDaoSession(DaoSession daoSession) {
        ...
        myDao = daoSession != null ? daoSession.getWena3EnergySampleDao() : null;
    }
