...
/** 
 * DAO for table "XIAOMI_ACTIVITY_SAMPLE".
*/
public class XiaomiActivitySampleDao extends AbstractDao<XiaomiActivitySample, Void> {

    public static final String TABLENAME = "XIAOMI_ACTIVITY_SAMPLE";

    /**
     * Properties of entity XiaomiActivitySample.<br/>
    ...
    */
    public static class Properties {
        ...
        public final static Property Stress = new Property(7, Integer.class, "stress", false, "STRESS");
        public final static Property Spo2 = new Property(8, Integer.class, "spo2", false, "SPO2");
    };

    private DaoSession daoSession;


    public XiaomiActivitySampleDao(DaoConfig config) {
        super(config);
    }
    
    public XiaomiActivitySampleDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"XIAOMI_ACTIVITY_SAMPLE\" (" + //
    ...
    public static void dropTable(SQLiteDatabase db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"XIAOMI_ACTIVITY_SAMPLE\"";
        db.execSQL(sql);
    }

    /** @inheritdoc */
    @Override
    protected void bindValues(SQLiteStatement stmt, XiaomiActivitySample entity) {
        stmt.clearBindings();
        ...
        if (stress != null) {
            stmt.bindLong(8, stress);
        }
 
        Integer spo2 = entity.getSpo2();
        if (spo2 != null) {
            stmt.bindLong(9, spo2);
        }
    }

    @Override
    protected void attachEntity(XiaomiActivitySample entity) {
    ...
    /** @inheritdoc */
    @Override
    public XiaomiActivitySample readEntity(Cursor cursor, int offset) {
        XiaomiActivitySample entity = new XiaomiActivitySample( //
            ...
            cursor.isNull(offset + 7) ? null : cursor.getInt(offset + 7), // stress
            cursor.isNull(offset + 8) ? null : cursor.getInt(offset + 8) // spo2
        );
        return entity;
    }
    ...
    /** @inheritdoc */
    @Override
    public void readEntity(Cursor cursor, XiaomiActivitySample entity, int offset) {
        ...
        entity.setStress(cursor.isNull(offset + 7) ? null : cursor.getInt(offset + 7));
        entity.setSpo2(cursor.isNull(offset + 8) ? null : cursor.getInt(offset + 8));
     }
    
    /** @inheritdoc */
    @Override
    protected Void updateKeyAfterInsert(XiaomiActivitySample entity, long rowId) {
    ...
    /** @inheritdoc */
    @Override
    public Void getKey(XiaomiActivitySample entity) {
        return null;
    }
    ...
    protected String getSelectDeep() {
        if (selectDeep == null) {
            ...
            builder.append(" FROM XIAOMI_ACTIVITY_SAMPLE T");
    ...
    protected XiaomiActivitySample loadCurrentDeep(Cursor cursor, boolean lock) {
        XiaomiActivitySample entity = loadCurrent(cursor, 0, lock);
    ...
    public XiaomiActivitySample loadDeep(Long key) {
        assertSinglePk();
        if (key == null) {
            return null;
        }
    ...
    public List<XiaomiActivitySample> loadAllDeepFromCursor(Cursor cursor) {
        int count = cursor.getCount();
        List<XiaomiActivitySample> list = new ArrayList<XiaomiActivitySample>(count);
    ...
    protected List<XiaomiActivitySample> loadDeepAllAndCloseCursor(Cursor cursor) {
        try {
    ...
    public List<XiaomiActivitySample> queryDeep(String where, String... selectionArg) {
