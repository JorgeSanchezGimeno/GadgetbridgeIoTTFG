...
/** 
 * DAO for table "WENA3_ACTIVITY_SAMPLE".
*/
public class Wena3ActivitySampleDao extends AbstractDao<Wena3ActivitySample, Void> {

    public static final String TABLENAME = "WENA3_ACTIVITY_SAMPLE";

    /**
     * Properties of entity Wena3ActivitySample.<br/>
    ...
    */
    ...
    public Wena3ActivitySampleDao(DaoConfig config) {
        super(config);
    }
    
    public Wena3ActivitySampleDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"WENA3_ACTIVITY_SAMPLE\" (" + //
    ...
    public static void dropTable(SQLiteDatabase db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"WENA3_ACTIVITY_SAMPLE\"";
        db.execSQL(sql);
    }

    /** @inheritdoc */
    @Override
    protected void bindValues(SQLiteStatement stmt, Wena3ActivitySample entity) {
        stmt.clearBindings();
    ...
    @Override
    protected void attachEntity(Wena3ActivitySample entity) {
    ...
    /** @inheritdoc */
    @Override
    public Wena3ActivitySample readEntity(Cursor cursor, int offset) {
        Wena3ActivitySample entity = new Wena3ActivitySample( //
    ...
    /** @inheritdoc */
    @Override
    public void readEntity(Cursor cursor, Wena3ActivitySample entity, int offset) {
    ...
    /** @inheritdoc */
    @Override
    protected Void updateKeyAfterInsert(Wena3ActivitySample entity, long rowId) {
    ...
    /** @inheritdoc */
    @Override
    public Void getKey(Wena3ActivitySample entity) {
        return null;
    }
    ...
    protected String getSelectDeep() {
        if (selectDeep == null) {
            ...
            builder.append(" FROM WENA3_ACTIVITY_SAMPLE T");
    ...
    protected Wena3ActivitySample loadCurrentDeep(Cursor cursor, boolean lock) {
        Wena3ActivitySample entity = loadCurrent(cursor, 0, lock);
    ...
    public Wena3ActivitySample loadDeep(Long key) {
        assertSinglePk();
        if (key == null) {
            return null;
        }
    ...
    public List<Wena3ActivitySample> loadAllDeepFromCursor(Cursor cursor) {
        int count = cursor.getCount();
        List<Wena3ActivitySample> list = new ArrayList<Wena3ActivitySample>(count);
    ...
    protected List<Wena3ActivitySample> loadDeepAllAndCloseCursor(Cursor cursor) {
        try {
    ...
    public List<Wena3ActivitySample> queryDeep(String where, String... selectionArg) {
