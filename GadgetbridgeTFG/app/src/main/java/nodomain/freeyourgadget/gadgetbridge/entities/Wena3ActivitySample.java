 ...
 */
public class Wena3ActivitySample extends AbstractActivitySample  {
    ...
    private transient Wena3ActivitySampleDao myDao;
    ...
    public Wena3ActivitySample() {
    }

    public Wena3ActivitySample(int timestamp, long deviceId) {
        this.timestamp = timestamp;
        this.deviceId = deviceId;
    }

    public Wena3ActivitySample(int timestamp, long deviceId, long userId, int steps, int rawKind, int heartRate) {
        this.timestamp = timestamp;
        this.deviceId = deviceId;
        this.userId = userId;
        this.steps = steps;
    ...
    public void __setDaoSession(DaoSession daoSession) {
        ...
        myDao = daoSession != null ? daoSession.getWena3ActivitySampleDao() : null;
    }
