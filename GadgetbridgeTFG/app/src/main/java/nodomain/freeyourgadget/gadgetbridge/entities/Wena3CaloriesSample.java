...
public class Wena3CaloriesSample extends AbstractTimeSample  {
    ...
    public Wena3CaloriesSample(long timestamp, long deviceId) {
        this.timestamp = timestamp;
        this.deviceId = deviceId;
    }

    public Wena3CaloriesSample(long timestamp, long deviceId, long userId, int calories) {
        this.timestamp = timestamp;
        this.deviceId = deviceId;
        this.userId = userId;
    ...
    public void __setDaoSession(DaoSession daoSession) {
        ...
        myDao = daoSession != null ? daoSession.getWena3CaloriesSampleDao() : null;
    }
