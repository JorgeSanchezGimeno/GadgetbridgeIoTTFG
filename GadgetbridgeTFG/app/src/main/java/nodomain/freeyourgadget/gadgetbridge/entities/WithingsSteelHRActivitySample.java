 ...
 */
public class WithingsSteelHRActivitySample extends AbstractActivitySample  implements java.io.Serializable {
    ...
    private transient WithingsSteelHRActivitySampleDao myDao;
    ...
    public WithingsSteelHRActivitySample() {
    }

    public WithingsSteelHRActivitySample(int timestamp, long deviceId) {
        this.timestamp = timestamp;
        this.deviceId = deviceId;
    }

    public WithingsSteelHRActivitySample(int timestamp, long deviceId, long userId, int duration, int rawKind, int steps, int distance, int calories, int heartRate, int rawIntensity) {
        this.timestamp = timestamp;
        this.deviceId = deviceId;
        this.userId = userId;
    ...
    public void __setDaoSession(DaoSession daoSession) {
        ...
        myDao = daoSession != null ? daoSession.getWithingsSteelHRActivitySampleDao() : null;
    }
