...
/** 
 * DAO for table "WENA3_STRESS_SAMPLE".
*/
public class Wena3StressSampleDao extends AbstractDao<Wena3StressSample, Void> {

    public static final String TABLENAME = "WENA3_STRESS_SAMPLE";

    /**
     * Properties of entity Wena3StressSample.<br/>
    ...
    */
    ...
    public Wena3StressSampleDao(DaoConfig config) {
        super(config);
    }
    
    public Wena3StressSampleDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"WENA3_STRESS_SAMPLE\" (" + //
    ...
    public static void dropTable(SQLiteDatabase db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"WENA3_STRESS_SAMPLE\"";
        db.execSQL(sql);
    }

    /** @inheritdoc */
    @Override
    protected void bindValues(SQLiteStatement stmt, Wena3StressSample entity) {
        stmt.clearBindings();
    ...
    @Override
    protected void attachEntity(Wena3StressSample entity) {
    ...
    /** @inheritdoc */
    @Override
    public Wena3StressSample readEntity(Cursor cursor, int offset) {
        Wena3StressSample entity = new Wena3StressSample( //
    ...
    /** @inheritdoc */
    @Override
    public void readEntity(Cursor cursor, Wena3StressSample entity, int offset) {
    ...
    /** @inheritdoc */
    @Override
    protected Void updateKeyAfterInsert(Wena3StressSample entity, long rowId) {
    ...
    /** @inheritdoc */
    @Override
    public Void getKey(Wena3StressSample entity) {
        return null;
    }
    ...
    protected String getSelectDeep() {
        if (selectDeep == null) {
            ...
            builder.append(" FROM WENA3_STRESS_SAMPLE T");
    ...
    protected Wena3StressSample loadCurrentDeep(Cursor cursor, boolean lock) {
        Wena3StressSample entity = loadCurrent(cursor, 0, lock);
    ...
    public Wena3StressSample loadDeep(Long key) {
        assertSinglePk();
        if (key == null) {
            return null;
        }
    ...
    public List<Wena3StressSample> loadAllDeepFromCursor(Cursor cursor) {
        int count = cursor.getCount();
        List<Wena3StressSample> list = new ArrayList<Wena3StressSample>(count);
    ...
    protected List<Wena3StressSample> loadDeepAllAndCloseCursor(Cursor cursor) {
        try {
    ...
    public List<Wena3StressSample> queryDeep(String where, String... selectionArg) {
